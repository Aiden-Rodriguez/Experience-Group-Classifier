The datasets I am using for my final project are Pokemon datasets. In the game Pokemon, each Pokemon gains levels at a different rate, and these rates can be classified into 6 different experience groups as follows. These groups are: Erratic, Fast, Medium Fast, Medium Slow, Slow, and Fluctuating. Pokemon in the Erratic group need less exp than Pokemon Fast group to reach level 100, Pokemon in the Fast group need less exp than Pokemon in the Medium Fast group to reach level 100, and so on.. Below is the graph of the experience distributions for reference. The reason I chose this dataset is simple - I like Pokemon and wanted to learn a little bit more about it from a data perspective.
...
Looking at the Fast group on this, it can be seen that the color "Pink" is the much more common in the fast experience group (in this case the "Pink" group is actually yellow, apologies). In the other experience groups the color pink is a fairly low percentage, but it seems to be much, much higher for the fast group. This comes back to the part of the previous conclusion - that this group is partially associated with cute Pokemon, and pink is a cutesy color.
